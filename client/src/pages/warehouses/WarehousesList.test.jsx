...
const sampleWarehouses = [
  { id: 'w1', name: 'Lahore', location: 'Lahore, PK', createdAt: '2026-01-10T00:00:00Z' },
];
...
describe('WarehousesList', () => {
  ...
  it('shows an empty state when there are no warehouses', async () => {
    ...
    await waitFor(() => expect(screen.getByText(/no warehouses yet/i)).toBeInTheDocument());
  });
  ...
  it('deletes a warehouse after confirmation and removes it from the list', async () => {
    ...
    await waitFor(() => expect(api.delete).toHaveBeenCalledWith('/warehouses/w1'));
